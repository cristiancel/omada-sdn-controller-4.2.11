...
RUN \
  ...
  cd /tmp/ &&\
  wget https://static.tp-link.com/2021/202102/20210209/Omada_SDN_Controller_v4.2.11_linux_x64.deb &&\
  ...
  DEBIAN_FRONTEND="noninteractive" dpkg -i /tmp/Omada_SDN_Controller_v4.2.11_linux_x64.deb &&\
  rm -f /usr/sbin/policy-rc.d && rm -f /tmp/Omada_SDN_Controller_v4.2.11_linux_x64.deb
